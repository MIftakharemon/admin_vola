                    ...
                    data.map((data, index) => {
                      return (
                        <tr key={index}>
                          ...
                          <td className="text-nowrap">{data?.userId?.username ? data?.userId?.username : "-"}
                            < IconCopy
                              size={16}
                              className="ms-1 text-nowrap"
                              style={{ cursor: "pointer" }}
                              onClick={() => copyToClipboard(data?.userId?.username ? data?.userId?.username : "-")}
                            />
                          </td>
                          <td>
                            {data?.userId?.uniqueId && data.userId.uniqueId !== "-" ? (
                              <div style={{ display: "flex", alignItems: "center" }}>
                                ...
                                <IconCopy
                                  ...
                                  className="ms-1"
                                  style={{ cursor: "pointer" }}
                                  onClick={() => copyToClipboard(data.userId.uniqueId)}
                                />
                              </div>
                            ) : (
                              "-"
