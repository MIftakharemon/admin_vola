                    ...
                    <>
                      ...
                      >
                        ...
                        <td className="text-success">
                          <img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data?.updatedAdminCoin}
                        </td>
                        <td
                          className={
                        ...
                        <td className="text-danger">
                          <img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} />  {parseInt(data?.winnerCoinMinus)}
                        </td>
                        <td className="text-warning"> <img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data?.totalAdd}</td>
