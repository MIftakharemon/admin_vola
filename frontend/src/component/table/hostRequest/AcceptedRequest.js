                    ...
                    data?.map((data, index) => {
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            {data?.user?.name ? data?.user?.name : data?.name} <IconCopy
                              size={16}
                              className="ms-1"
                              style={{ cursor: "pointer" }}
                              onClick={() => copyToClipboard(data?.user?.name ? data?.user?.name : data?.name)}
                            />
                          </td>

                          <td>{data?.agencyCode ? data?.agencyCode : "-"} <IconCopy
                            size={16}
                            className="ms-1"
                            style={{ cursor: "pointer" }}
                            onClick={() => copyToClipboard(data?.agencyCode ? data?.agencyCode : "-")}
                          /></td>
