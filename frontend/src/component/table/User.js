...
const UserTable = (props) => {
  ...
  const canEdit = can('admin/user', 'Edit');
                    ...
                    data?.map((data, index) => {
                      return (
                        <tr key={index}>
                          ...
                          <td>{data?.uniqueId ? data?.uniqueId : '-'}
                            <IconCopy
                              size={16}
                              className="ms-1"
                              style={{ cursor: "pointer" }}
                              onClick={() => copyToClipboard(data?.uniqueId ? data?.uniqueId : '-')}
                            />
                          </td>
                          <td>
                            {data?.gender ? (
                              ...
                              >
                                {data.gender.toLowerCase() === "male" && (
                                  <i className="material-icons text-primary">male</i>
                                )}

                                {data.gender.toLowerCase() === "female" && (
                                  <i className="material-icons text-danger">female</i>
                                )}
                            ...
                            <img src={Rcoin} width="15px" height="15px" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data?.rCoin ? data?.rCoin : '0'}
                          </td>
                          <td className="text-danger">
                            <img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data?.diamond ? data?.diamond : '0'}
                          </td>
