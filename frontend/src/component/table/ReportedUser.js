                      ...
                      return (
                        <>
                          ...
                          >
                            ...
                            <td>{data._id.name}</td>
                            <td className="text-success"><img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data._id.diamond}</td>
                            <td className="text-warning"><img src={Rcoin} width="15px" height="15px" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data._id.rCoin}</td>
