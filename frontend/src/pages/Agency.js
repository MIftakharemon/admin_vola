...
const AgencyDetails = (props) => {
  ...
  const handleOpen = () => {
    if (agency?.length >= 1) {
      Toast("error", 'you can only create one agency!');
      return;
    }
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td className="text-success">
                            <img src={Rcoin} width="15px" height="15px" style={{ verticalAlign: "middle", marginRight: "1px" }} />  {data?.totalCoin ? data?.totalCoin : 0}
                          </td>
                          <td>
