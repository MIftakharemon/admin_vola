                    ...
                    data.map((data, index) => {
                      return (
                        <tr key={index}>
                            ...
                            {data?.user?.uniqueId && data.user.uniqueId !== "-" ? (
                              <>
                                ...
                                <IconCopy
                                  ...
                                  onClick={() => copyToClipboard(data.user.uniqueId)}
                                />
                              </>
                            ) : (
                              "-"
                          ...
                          <td className="text-nowrap"><img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data?.coin}</td>
                          <td><img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data?.spendCoin}</td>
                          <td>
                            <div
