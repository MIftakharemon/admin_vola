                            ...
                            <tr key={index}>
                                ...
                                data.income ? (
                                  data.diamond !== 0 ? (
                                    <td className="text-success">
                                      <img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} />  +{data.diamond}
                                    </td>
                                  ) : (
                                    <td>{data.diamond}</td>
                                  )
                                  ...
                                  <td><img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data.diamond}</td>
                                )
                              ) : (
                                <td>0</td>
                              )}
                              ...
                              {data.rCoin ? (
                                data.income ? (
                                  data.rCoin !== 0 ? (
                                    <td className="text-success">
                                      <img src={Rcoin} width="15px" height="15px" style={{ verticalAlign: "middle", marginRight: "1px" }} /> +{data.rCoin}
                                    </td>
                                  ) : (
                                    <td>{data.rCoin}</td>
                                  )
                                ...
                                <td>  <img src={Rcoin} width="15px" height="15px" style={{ verticalAlign: "middle", marginRight: "1px" }} /> 0</td>
                              )}
                          ...
                          return (
                            <tr key={index}>
                              ...
                              {data.callConnect && data.type === "Outgoing" ? (
                                <td className="text-red"> b<img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} />-{data.diamond}</td>
                              ) : (
                                <td><img src={Diamond} width="15" height="15" style={{ verticalAlign: "middle", marginRight: "1px" }} />0</td>
                              )}

                              <td> <img src={Rcoin} width="15px" height="15px" style={{ verticalAlign: "middle", marginRight: "1px" }} /> {data.date}</td>
                            </tr>
                          );
                        })
                      ) : (
